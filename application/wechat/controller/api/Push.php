...
class Push extends Controller
{
     ...
     * @var string
     */
    protected $openid = "wxb4483fd1627ab981";
     ...
     * @throws \think\exception\PDOException
     */
    public function sendMessage($type, $data, $isCustom = false)
    {
        if ($isCustom) {
            return WechatService::WeChatCustom()->send(['touser' => 'omnAdwVazqCLkokBzS9DBR8kiDoc', 'msgtype' => $type, "{$type}" => $data]);
